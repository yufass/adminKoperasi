...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row invoice-card-row">
            ...
            <a href="<?= base_url('pengguna') ?>" class="col-xl-3 col-xxl-3 col-sm-6">
                <div>
        ...
        <div class="row">
            ...
            <a href="<?= base_url('pinjaman/tagihan') ?>" class="col-xl-3 col-xxl-3">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        <div>
                            <h2 class="text-white invoice-num">Total Tagihan Pinjaman Anggota</h2>
                            <span class="text-white fs-18">Sisa Bayar : <br/><?= 'Rp. ' . number_format($totalTagihanPinjamanAnggota, 2, ',', '.'); ?></span>
                        </div>
                    </div>
                </div>
            </a>
